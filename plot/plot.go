...
var (
	...
	htmlTemplate = template.Must(template.New("github.com/matthew188/dataframe-go/plot/html").Parse(titleHTML))
	imgTemplate  = template.Must(template.New("github.com/matthew188/dataframe-go/plot/img").Parse(imgHTML))
)
